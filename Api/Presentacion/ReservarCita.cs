...
namespace Presentacion
{
    public partial class ReservarCita : Form
    {
        ...
        {
            obj2.ReservarCita(Convert.ToInt32(dataGridViewCitas.CurrentRow.Cells[0].Value.ToString()), cedula, Convert.ToDateTime(dataGridViewCitas.CurrentRow.Cells[4].Value.ToString()));
            dataGridViewCitas.DataSource = obj2.ObtenerCita(comboBoxNombreCentro.Text);
        }
    }
}
